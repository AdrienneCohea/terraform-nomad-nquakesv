// message of the day -- displayed when you connect to the server (max 15 rows [i.e. k_motd15])
set k_motd1                     "${name}"
set k_motd2                     ""
...
set sv_www_address              "${report_url}"       // URL to send match/race results to
set sv_www_authkey              "${report_key}"       // contact meag to find out what string to put here
